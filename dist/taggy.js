...
function taggy(el, options) {
  ...
  function createAutocomplete() {
    ...
    function suggest(q, done) {
      ...
      if (entry) {
        var fresh = entry.created + cache.duration > new Date();
        if (fresh) {
